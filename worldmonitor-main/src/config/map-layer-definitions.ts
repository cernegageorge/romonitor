...
export type MapVariant = 'full' | 'tech' | 'finance' | 'happy' | 'commodity' | 'energy' | 'romania';
...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  ...
  romania: [
    'hotspots', 'conflicts', 'bases', 'nuclear', 'cables', 'pipelines', 'waterways', 'tradeRoutes',
    'outages', 'weather', 'canadaRoads', 'canadaAlerts', 'economic', 'sanctions', 'dayNight',
    'resilienceScore', 'natural', 'fires', 'climate', 'ais', 'flights', 'protests', 'datacenters',
  ],
};
