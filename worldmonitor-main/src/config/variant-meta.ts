...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  romania: {
    title: 'World Monitor România - Dashboard de inteligență pentru România',
    description: 'Dashboard de inteligență pentru România, cu știri locale, piețe, energie, infrastructură, politici, riscuri geopolitice și context regional în limba română.',
    keywords: 'Romania dashboard, România știri, economie România, energie România, BVB, OPCOM, infrastructură România, risc geopolitic România, inteligență locală, monitorizare România',
    url: 'https://romania.worldmonitor.app/dashboard',
    siteName: 'World Monitor România',
    shortName: 'WM România',
    subject: 'Inteligență locală pentru România, economie, energie și risc regional',
    classification: 'Dashboard România, Inteligență locală, Monitorizare de risc',
    categories: ['news', 'business'],
    features: [
      'Știri și evenimente locale din România',
      'Economie și piețe financiare',
      'Energie și piață OPCOM',
      'Infrastructură critică și transport',
      'Context geopolitic regional',
      'Monitorizare macro și riscuri',
      'Filtru implicit pe România',
      'Interfață în limba română',
      'Context global cu focalizare locală',
    ],
  },
};
