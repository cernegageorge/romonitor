 ...
 * the two drift apart.
 */
export const SITE_VARIANTS = ['full', 'tech', 'finance', 'happy', 'commodity', 'energy', 'romania'] as const;
...
export const SITE_VARIANT: string = (() => {
  ...
  if (h.startsWith('romania.')) return 'romania';
  if (h === 'worldmonitor.ro' || h === 'www.worldmonitor.ro' || h.endsWith('.worldmonitor.ro')) return 'romania';
