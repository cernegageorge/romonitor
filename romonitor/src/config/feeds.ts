...
// Romania variant feeds — Romania-focused default pack with local and regional coverage.
const ROMANIA_FEEDS: Record<string, Feed[]> = {
  'live-news': [
    { name: 'Digi24', url: rss('https://www.digi24.ro/rss') },
    { name: 'HotNews', url: rss('https://www.hotnews.ro/rss') },
    { name: 'Mediafax', url: rss('https://www.mediafax.ro/rss') },
    { name: 'G4Media', url: rss('https://www.g4media.ro/feed/') },
  ],
  politics: [
    { name: 'Digi24', url: rss('https://www.digi24.ro/rss') },
    { name: 'HotNews', url: rss('https://www.hotnews.ro/rss') },
  ...
  economic: [
    ...
    { name: 'Profit.ro', url: rss('https://www.profit.ro/rss') },
    { name: 'Bursa.ro', url: rss('https://news.google.com/rss/search?q=site:bursa.ro+Romania+when:3d&hl=ro&gl=RO&ceid=RO:ro') },
    { name: 'Business Review', url: rss('https://www.business-review.eu/rss') },
  ],
  markets: [
    { name: 'BVB', url: rss('https://www.bvb.ro/News/rss') },
    { name: 'Ziarul Financiar', url: rss('https://www.zf.ro/rss') },
    { name: 'Profit.ro', url: rss('https://www.profit.ro/rss') },
    { name: 'Reuters Markets Romania', url: rss('https://news.google.com/rss/search?q=site:reuters.com+Romania+markets+when:3d&hl=en-US&gl=US&ceid=US:en') },
  ],
  energy: [
  ...
  gov: [
    ...
    { name: 'Agerpres', url: rss('https://www.agerpres.ro/rss') },
    { name: 'Romanian Government News', url: rss('https://news.google.com/rss/search?q=site:gov.ro+Romania+when:3d&hl=ro&gl=RO&ceid=RO:ro') },
    { name: 'EU Council Romania', url: rss('https://news.google.com/rss/search?q=site:consilium.europa.eu+Romania+policy+when:7d&hl=en-US&gl=US&ceid=US:en') },
  ],
};
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  // Romania variant regions
  romaniaPolitics: { labelKey: 'header.sourceRegionRomania', feedKeys: ['politics', 'gov'] },
  romaniaEconomy: { labelKey: 'header.sourceRegionRomaniaEconomy', feedKeys: ['economic', 'markets'] },
  romaniaEnergy: { labelKey: 'header.sourceRegionRomaniaEnergy', feedKeys: ['energy'] },
